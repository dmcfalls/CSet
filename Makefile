...
#
# Modified for use in CSet personal project. Dan McFalls, December 2015.
#
...
#  -O2		   compile with standard optimizations
...
CFLAGS = -g -O0 -std=gnu99 -Wall $$warnflags -fno-omit-frame-pointer -fno-stack-protector
...
# lists CSet.h to be treated as a prerequisite.
%.o: %.c CSet.h
	$(COMPILE.c) -I. $< -o $@
